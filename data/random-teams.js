...
const metronomeSets = require('./metronome-sets.json');
...
class RandomTeams extends Dex.ModdedDex {
	...
	constructor(format, prng) {
		...
		this.metronomeSets = metronomeSets;
	...
	randomShedinjaMetronomeTeam() {
		let pokemon = [this.getMetronomeSet('shedinja'), this.getMetronomeSet('shedinja'), this.getMetronomeSet('shedinja'), this.getMetronomeSet('shedinja'), this.getMetronomeSet('shedinja'), this.getMetronomeSet('shedinja')];
		return pokemon;
	}

	randomArceusMetronomeTeam() {
		let pokemon = [this.getMetronomeSet('arceus'), this.getMetronomeSet('arceus'), this.getMetronomeSet('arceus'), this.getMetronomeSet('arceus'), this.getMetronomeSet('arceus'), this.getMetronomeSet('arceus')];
		return pokemon;
	}

	getMetronomeSet(species) {
		let sets = this.metronomeSets[species]['sets'];
		let randomNumber = Math.floor(Math.random() * (sets.length));
		return sets[randomNumber];
	}
